...
class TicTacToe():
    ...
    def print_board(self):
        ...
        for row in [self.board[i*3:(i+1) * 3] for i in range(3)]:
            test = test + '| ' + ' | '.join(row) + " | <br> " 
        document.getElementById("tic-tac-toe-result").innerHTML =  test
        print(test)
...
function_proxy = create_proxy(playAgain)

document.getElementById("button-tic-tac-toe").addEventListener("click", function_proxy)